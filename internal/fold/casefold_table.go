// Code generated by pkm/tools/lcs/generate_casefold_table.py; DO NOT EDIT.
...
//
// The same generator and input produce the kernel's table in
// pkm/crates/lcs-core/src/casefold_table.rs, so the two fold identically.

package fold

// caseFoldRange folds every rune in [start, end] to mapped_start + (r - start).
type caseFoldRange struct {
	start, end, mappedStart rune
}

// caseFoldPair folds one rune to another.
type caseFoldPair struct {
	source, target rune
}

// caseFoldMappings is the number of C and S rows in the source file.
const caseFoldMappings = 1484

var caseFoldRanges = [...]caseFoldRange{
